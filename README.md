...
The catalog is sorted **alphabetically by folder name** (the lab `id`). To control display order, prefix directory names with numbers. Shipped labs: **`01-kubectl-basics`**, **`02-deployment-basics`**, **`03-workloads-probes-scaling`**, **`04-incident-drills`**.
